...
class Settings:
    ...
    database_path: Path = Path(os.getenv("RETRIVR_DB_PATH", "retrievr.db"))
    storage_dir: Path = Path(os.getenv("RETRIVR_STORAGE_DIR", "storage/images"))
    vectors_dir: Path = Path(os.getenv("RETRIVR_VECTORS_DIR", "vectors"))
